...
public class NWChemLog2CompchemConverterTest {
    ...
    public void testH2oSto3gNoTitle() throws Exception {
        ...
        //compchem:calculation_type
        nodes = CMLUtil.getQueryNodes(doc, "/cml:*[@convention='convention:compchem']/cml:module[@dictRef='compchem:jobList']/cml:module[@dictRef='compchem:job']/cml:module[@dictRef='compchem:initialization']/cml:parameterList/cml:parameter[@dictRef='compchem:calculation_type']/cml:scalar/text()", CMLConstants.CML_XPATH);
        assertFalse(nodes.isEmpty());
        ...
        // calculation_type for initial_guess
        nodes = CMLUtil.getQueryNodes(doc, "/cml:*[@convention='convention:compchem']//cml:module[@dictRef='compchem:calculation' and @id='initial_guess']/cml:module[@dictRef='compchem:initialization']/cml:parameterList/cml:parameter[@dictRef='compchem:calculation_type']/cml:scalar/text()", CMLConstants.CML_XPATH);
        assertFalse(nodes.isEmpty());
