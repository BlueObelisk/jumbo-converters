...
public class ConverterTest {
    ...
    public void molcasOut2XML() {
		TemplateConverter converter = createConverter("org/xmlcml/cml/converters/compchem/molcas/log/topTemplate.xml");
	...
	private TemplateConverter createConverter(String templateXML) {
		...
		try {
			...
			converter = CompchemTemplateConverter.createTemplateConverter(templateStream, "molcas", "log");
		} catch (Exception e) {
