...
public class GamessUSPunchBlockOld extends AbstractBlock {
...
//			" ------------------------------------------------------------";
	...
	public static Logger LOG = Logger.getLogger(GamessUSPunchBlockOld.class);
...
//	private static final String DICTREF_NEXT = "dictRefNext";
	...
	public GamessUSPunchBlockOld(BlockContainer blockContainer) {
