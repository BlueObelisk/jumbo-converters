 ...
 */
public class Link202 extends GaussianLink {
	@SuppressWarnings("unused")
	private static Logger LOG = Logger.getLogger(Link202.class);
...
//	};
    ...
    protected String getTitle() {
    	return "Reorients coordinates, calculates symmetry, and checks variables";	
     }
