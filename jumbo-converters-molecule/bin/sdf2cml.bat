...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="sdf2cml" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.xmlcml.cml.converters.molecule.mdl.SDF2CMLConverter %CMD_LINE_ARGS%
