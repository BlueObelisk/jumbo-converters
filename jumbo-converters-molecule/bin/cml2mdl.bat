...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="cml2mdl" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.xmlcml.cml.converters.molecule.mdl.CML2MDLConverter %CMD_LINE_ARGS%
